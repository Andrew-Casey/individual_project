...
def the_chosen_one2(X_train_scaled, X_test_scaled, y_train, y_test):
    """
    ...
    logit = LogisticRegression(C=0.10, random_state=123)
    logit.fit(X_train_scaled, y_train)
    logit.score(X_test_scaled, y_test)

    return logit.score(X_test_scaled, y_test)
